...
#ifndef OCTOMAP_FUSION_H
#define OCTOMAP_FUSION_H
...
namespace tracking_slam
{
    ...
    public:
        ...
        void insertOneScan2FullMapAndPub( KeyFrame* kf, octomap::Pointcloud& point_cloud_c, octomap::Pointcloud& point_cloud_color );
        void fusionAndPub();  
